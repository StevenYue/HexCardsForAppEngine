	...
	private int typeThreeCompare(Hand hand1, Hand hand2) {
		if(hand1.getValue()[0] > hand2.getValue()[0]) return 1;
			...
			if(hand1.getValue()[1] > hand2.getValue()[1]) return 1;
				...
				if(hand1.getValue()[1] == FLUSHHAND){
					if (hand1.getValue()[3] > hand2.getValue()[3])
						return 1;
					else if (hand1.getValue()[3] < hand2.getValue()[3])
						return -1;
					else {
						if (hand1.getValue()[2] > hand2.getValue()[2])
							return 1;
						else if (hand1.getValue()[2] < hand2.getValue()[2])
							return -1;
						else {
							return 0;
						}
